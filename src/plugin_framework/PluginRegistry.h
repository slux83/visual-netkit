...
public:
	...
	QList<PluginProxy*> getAllHiProxies()					{ return hiAssociations.values(); };
	QList<PluginProxy*> getAllCdProxies()					{ return cdAssociations.values(); };
	QList<PluginProxy*> getAllVmProxies()					{ return vmAssociations.values(); };
