...
#ifndef PLUGINQUAGGABGP_H_
#define PLUGINQUAGGABGP_H_
...
/**
 * Quagga-bgp plugin class
 */
class PluginQuaggaBgp : public PluginInterface
{
...
public:
	...
	QString getDefaultGraphisLabel() {return QString("quagga-bgp"); };
	QString getXMLResource() { return ":/quagga-bgp/xml-conf"; };
